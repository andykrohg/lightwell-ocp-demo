...
echo ""
echo "  spring-boot 2.7.18     — CVE-2025-22235, CVE-2026-40973        High"
echo "  spring-framework 5.3.18 — CVE-2023-20860/61/63, CVE-2024-38808/16, CVE-2025-41249  High"
...
echo "  logback 1.2.12         — CVE-2023-6378, CVE-2024-12801         High"
echo "  snakeyaml 1.33         — CVE-2022-1471 (Arbitrary code exec)   Critical"
echo ""
...
echo ""
echo "  spring-boot    2.7.18     ->  2.7.18.rhlw-00004"
echo "  spring-fwk     5.3.18     ->  5.3.18.rhlw-00010"
...
echo "  logback        1.2.12     ->  1.2.12.rhlw-00005"
echo "  snakeyaml      1.33       ->  1.33.0.rhlw-00001"
echo ""
narrate "No code changes required. Just switch the Maven profile."
narrate ""
narrate "Lightwell also publishes real OSV vulnerability data alongside its"
narrate "remediated packages. During setup, we pulled this data and uploaded"
narrate "it to TPA. The pipeline uses it to verify which CVEs are resolved."
pause
...
narrate "  was applied. The CVEs covered by VEX are now suppressed —"
...
narrate "Lightwell's VEX data suppresses the known CVEs, proving the"
